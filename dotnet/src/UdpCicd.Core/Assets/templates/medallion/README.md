...
Medallion lakehouse architecture (bronze/silver/gold) managed by [Unified Data Platform Deployment](https://github.com/PatrickGallucci/udp-cicd).

## Project Structure

```
${{project_name}}/
├── udp.yml                          # Deployment definition
├── notebooks/
...
```bash
# Update udp.yml with your capacity_id, then:
udp-cicd validate
udp-cicd plan -t dev
