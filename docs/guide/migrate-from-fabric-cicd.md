...
If you're using [fabric-cicd](https://github.com/microsoft/fabric-cicd), here's how to migrate to udp-cicd.

## Comparison

| | fabric-cicd | udp-cicd |
|---|------------|-----------|
...
### 2. Review the generated udp.yml
