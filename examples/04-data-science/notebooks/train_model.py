...
model_type = spark.conf.get("spark.udp.params.model_type", "xgboost")
n_estimators = int(spark.conf.get("spark.udp.params.n_estimators", "100"))
learning_rate = float(spark.conf.get("spark.udp.params.learning_rate", "0.1"))
