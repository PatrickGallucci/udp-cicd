...
This project uses **Unified Data Platform Deployment** (`udp-cicd`) to manage Microsoft Fabric resources.

### MCP Server

If configured in `.github/copilot-mcp.json`, you have access to these tools via the `udp-cicd-mcp` MCP server:
...
- `udp.yml` — Platform definition for Microsoft Unified Data Platform (lakehouses, notebooks, pipelines, security, targets)
