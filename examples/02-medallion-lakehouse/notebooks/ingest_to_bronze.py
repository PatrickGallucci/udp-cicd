...
# Parameters (overridable via udp-cicd run --param)
source_path = spark.conf.get("spark.udp.params.source_path", "/mnt/raw")
batch_date = spark.conf.get("spark.udp.params.batch_date", "2024-01-01")
